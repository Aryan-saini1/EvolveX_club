  ...
  return (
    <nav 
      className={cn(
        ...
        scrolled ? "nav-glass shadow-lg py-3" : "bg-black/80 backdrop-blur-lg py-4 md:py-5"
      )}
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <button 
          className="md:hidden text-white p-2 bg-red-700/70 rounded-md hover:bg-red-800/80 transition-colors shadow-md"
      ...
      >
        <button 
          className="absolute top-5 right-5 text-white bg-red-700/70 p-2 rounded-full hover:bg-red-800/80 transition-colors shadow-lg"
